...
**103 library files** across 1 module
...
- `extensions/workflow-monitor/auto-action-keys.ts` — ticketOperationFromPrompt, idleUserMessageKey, ticketAutoWorkflowActionKey, ticketPendingActionMatches, autoWorkflowActionKey, autoWorkflowActionKeyForAction, …
