...
**84 library files** across 1 module
...
- `extensions/workflow-monitor/slice-plan-progress.ts` — allTasksInCurrentPlanAreClosed, unfinishedLifecycleStepsFromMarkdown, refreshWorkflowTasksFromPlan, nextPromptForPhase, nextPromptForActivePlanLifecycle, nextWorkflowActionForActivePlanLifecycle, …
